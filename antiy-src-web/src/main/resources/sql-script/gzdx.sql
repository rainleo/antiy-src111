...
CREATE TABLE `task_info`  (
  ...
  `task_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '任务名称',
...
CREATE TABLE `user`  (
  ...
  `phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系电话',
...
CREATE TABLE `vul_info`  (
     ...
     `vul_address` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '漏洞地址',
     ...
     PRIMARY KEY (`id`) USING BTREE,
     INDEX `N_TASK_INDEX`(`task_id`) USING BTREE,
     INDEX `D_ADD_CL_C_INDEX`(`vul_department`, `address_owner`, `vul_level`, `create_user`, `vul_status`) USING BTREE,
     INDEX `NAME_NO_ADD_INDEX`(`vul_no`, `vul_name`, `vul_address`) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
